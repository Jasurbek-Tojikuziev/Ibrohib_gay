...
@TeleOp(name = "BLUE Alliance TeleOp SERVO", group = "TeleOp")
public class BlueAllianceTeleOpServo extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (!isStarted() && !isStopRequested()) {
            ...
            telemetry.addLine("=== BLUE ALLIANCE TELEOP — SERVO TURRET ===");
            telemetry.addLine();
        ...
        robot.setGoalPose(blueGoalPose);
        ...
        while (opModeIsActive()) {
            ...
            // Dpad UP — far-zone position reset
            ...
            if (didReset) robot.setGoalPose(blueGoalPose);
