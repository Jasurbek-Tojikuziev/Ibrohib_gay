...
// NOTE: Singleton instance persists across OpMode transitions (Auto → TeleOp by design).
// If running multiple test OpModes in sequence, position carries over — restart the app
// or call setPosition(0,0,0) manually at the start of each test OpMode if needed.
public class Localizer {
     ...
     * x, y - в дюймах, heading - в градусах
