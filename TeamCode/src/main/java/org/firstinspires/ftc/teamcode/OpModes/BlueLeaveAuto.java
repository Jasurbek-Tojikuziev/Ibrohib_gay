...
@Autonomous(name = "Blue Leave Auto", group = "Autonomous", preselectTeleOp = "BLUE Alliance TeleOp")
public class BlueLeaveAuto extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        telemetry.addLine("Blue Leave Auto — Ready");
        telemetry.update();
        ...
        // Blue starts at heading 180° — forward power drives backward away from wall
